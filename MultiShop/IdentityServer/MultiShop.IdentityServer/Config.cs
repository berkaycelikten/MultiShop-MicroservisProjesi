...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes => new ApiScope[]
        {
            ...
            new ApiScope("ImageFullPermisson","Full authority for ımage operations"),
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                AllowedScopes={"CatalogReadPermission","CatalogFullPermission","OcelotFullPermisson","CommentFullPermisson","ImageFullPermisson","CommentFullPermisson","BasketFullPermisson",
            ...
            new Client
            {
                ...
                ClientSecrets={new Secret("multishopsecret".Sha256()) },
                AllowedScopes={ "CatalogReadPermission", "CatalogFullPermission", "BasketFullPermisson", "DiscountFullPermission", "OcelotFullPermisson", "CommentFullPermisson", "PaymentFullPermisson", "ImageFullPermisson", "OrderFullPermisson","CargoFullPermisson",
            ...
            new Client
            {
                ...
                AllowedScopes={ "CatalogFullPermission", "CatalogReadPermission", "DiscountFullPermission",
                    "OrderFullPermisson","CargoFullPermisson","BasketFullPermisson","OcelotFullPermisson","CommentFullPermisson","PaymentFullPermisson","ImageFullPermisson",
                IdentityServerConstants.LocalApi.ScopeName,
                IdentityServerConstants.StandardScopes.Email,
                IdentityServerConstants.StandardScopes.OpenId,
                IdentityServerConstants.StandardScopes.Profile
