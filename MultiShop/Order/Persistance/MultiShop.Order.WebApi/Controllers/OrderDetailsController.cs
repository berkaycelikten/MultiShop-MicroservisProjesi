...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> OrDetailList()
        {
        ...
        {
            var values = await _getOrderDetailByIdQueryHandler.Handle(new Application.Features.CQRS.Queries.OrderDetailQueries.GetOrderDetailByIdQuery(id));
            return Ok(values);
        }
        [HttpPost]
        ...
        public async Task<IActionResult> RemoveOrderDetail(int id)
        {
            ...
            return Ok("Sipariş detayı başarıyla silidindi");
        }
    }
}
